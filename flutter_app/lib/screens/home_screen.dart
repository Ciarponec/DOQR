      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            children: [
              ListTile(
                title: const Text('QR ile ring testi'),
                onTap: () => Navigator.pushNamed(context, '/qr-ring'),
              ),
              ListTile(
                title: const Text('Share token kabul et'),
                onTap: () => Navigator.pushNamed(context, '/share-accept'),
              ),
              const Divider(),
